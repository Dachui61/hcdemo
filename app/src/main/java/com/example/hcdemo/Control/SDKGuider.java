package com.example.hcdemo.Control;
...
public class SDKGuider{
    ...
    //ISAPI协议透传接口
    public DevTransportGuider m_comTransportGuider = new com.example.hcdemo.Control.DevTransportGuider();
    //串口透传接口
    public DevPassThroughGuider m_comSerialTransGuider = new com.example.hcdemo.Control.DevPassThroughGuider();
    //设备管理接口
    public com.example.hcdemo.Control.DevManageGuider m_comDMGuider = new com.example.hcdemo.Control.DevManageGuider();
    //设备远程设置接口
    public DevConfigGuider m_comConfGuider = new DevConfigGuider();
    //设备报警接口
    public DevAlarmGuider m_comDevAlarmGuider = new DevAlarmGuider();
    //关于回放接口
    public com.example.hcdemo.Control.DevPlayBackGuider m_comPBGuider = new com.example.hcdemo.Control.DevPlayBackGuider();
    //预览相关接口
    public com.example.hcdemo.Control.DevPreviewGuider m_comPreviewGuider = new com.example.hcdemo.Control.DevPreviewGuider();
    //SDK初始化
    public SDKGuider(){
        initNetSdk_jna();
    }
