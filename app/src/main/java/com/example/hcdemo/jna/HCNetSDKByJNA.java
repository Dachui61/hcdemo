package com.example.hcdemo.jna;
...
//		}
	...
	public static class NET_VCA_BLOCKLIST_INFO_ALARM extends Structure
	{
        ...
        protected List<String> getFieldOrder() {
        // TODO Auto-generated method stub
            return Arrays.asList("struBlOckListInfo", "dwBlockListPicLen", "dwFDIDLen", "pFDID", "dwPIDLen", "pPID",
	...
	public static class NET_VCA_FACESNAP_MATCH_ALARM extends Structure
	{
        ...
        protected List<String> getFieldOrder() {
        // TODO Auto-generated method stub
            return Arrays.asList("dwSize", "fSimilarity", "struSnapInfo", "struBlockListInfo", "sStorageIP", "wStoragePort",
